...
// Styled components from old code
...
const ProductPage = () => {
    ...
    return (
        <Container className="d-flex flex-column justify-content-end mx-auto p-4 my-4" fluid>
            <Row>
                {productsArray.map((product, index) => (
                    <Col key={index} xs={12} sm={12} md={6} lg={4} xxl={3} className="pb-4">
                        <StyledCard className="card shadow-md p-2 p-md-4 m-2">
                            ...
                            <Card.Footer className="text-center">
                                <Button variant="primary" className="px-5" onClick={() => dispatch(addToCart(product))}>
                                    Add to Cart
                                </Button>
                            </Card.Footer>
                        </StyledCard>
